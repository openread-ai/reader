...
const logger = createLogger('opds-catalog');
...
export function CatalogManager() {
  ...
  const handleAddCatalog = async () => {
    ...
    try {
      ...
      logger.error('Failed to add catalog', e);
      setUrlError(e instanceof Error ? e.message : _('Failed to validate catalog'));
    } finally {
  ...
  const handleOpenCatalog = (catalog: OPDSCatalog) => {
    ...
    window.location.href = `/opds?${params.toString()}`;
  };
